...
**Dimension**: A dimension value is a string with a unit suffix. Valid units are: pt, px, em, rem. (`pt` is the Apple/SwiftUI edition's addition; px/em/rem remain accepted.)
